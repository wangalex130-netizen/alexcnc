            ...
            children: [
              ...
              Container(
                ...
                child: value
                    ...
                    ? const Icon(Symbols.check, size: 15, color: Colors.black)
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Row(
          ...
          children: [
            ...
            const Icon(Symbols.warning_amber, color: CncColors.danger),
          ...
          child: FilledButton.icon(
            ...
            icon: Icon(
                ...
                ready
                    ...
                    ? (widget.synced ? Symbols.check_circle : Symbols.sync)
            ...
            SizedBox(
              ...
              child: GridView.count(
                ...
                children: [
                  ...
                  _J(icon: Symbols.arrow_upward, onTap: () => _move(0, 1)),

                  const SizedBox(),

                  _J(icon: Symbols.arrow_left, onTap: () => _move(-1, 0)),

                  _J(label: '设\n原点', onTap: _setOrigin, primary: true),

                  _J(icon: Symbols.arrow_right, onTap: () => _move(1, 0)),

                  const SizedBox(),

                  _J(icon: Symbols.arrow_downward, onTap: () => _move(0, -1)),
...
class _J extends StatelessWidget {
  ...
  const _J({this.label, this.icon, required this.onTap, this.primary = false});
        ...
        SizedBox(
          ...
          child: FilledButton.icon(
            ...
            icon: launching
                ...
                : const Icon(Symbols.play_arrow, color: Colors.black),
