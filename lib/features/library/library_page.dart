        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Icon(Symbols.cloud_off, size: 42, color: CncColors.textSub),
...
Widget _gradient() => Container(
      ...
      child: const Center(child: Icon(Symbols.image, color: Colors.white70, size: 28)),
